...
class TestSecurityService:
    ...
    async def test_evaluate_security_question_success(self, security_service):
        ...
        security_service.aws_connector.get_resources_by_service = AsyncMock(
            return_value=[{"service": "iam", "type": "user", "user_name": "test-user"}]
        )

        # Mock validators
        security_service._run_security_validators = AsyncMock(
            return_value={"SEC01-BP01": {"status": "compliant", "score": 100}}
        )
    ...
    def test_calculate_security_scoring(self, security_service):
        validation_results = {"SEC01-BP01": {"score": 100}, "SEC01-BP02": {"score": 80}}
