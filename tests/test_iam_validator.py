def test_iam_password_policy_and_root_mfa(monkeypatch):
    class FakeIAM:
        def get_account_password_policy(self):
            return {'PasswordPolicy': {'MinimumPasswordLength': 14, 'RequireSymbols': True, 'RequireNumbers': True, 'RequireUppercaseCharacters': True, 'RequireLowercaseCharacters': True}}
