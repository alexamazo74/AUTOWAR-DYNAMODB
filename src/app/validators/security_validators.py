    ...
    try:
        ...
        if total_users > 0:
            ...
            if users_with_policies < total_users:
                details.append(
                    f"{total_users - users_with_policies} users without attached policies"
                )
        ...
        if total_roles > 0:
            ...
            if roles_with_policies < total_roles:
                details.append(
                    f"{total_roles - roles_with_policies} roles without attached policies"
                )
...
async def validate_sec01_bp07(resources: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "score": score,
            "details": details,
            "evidence": {"analyzers_enabled": analyzers_enabled},
        }
    ...
    try:
        ...
        if programmatic_access_count == 0:
            ...
            if appropriate_credentials < programmatic_access_count:
                details.append(
                    f"{programmatic_access_count - appropriate_credentials} programmatic users need better credentials"
                )
...
async def validate_sec03_bp01(resources: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "score": score,
            "details": details,
            "evidence": {"total_users": total_users, "users_with_mfa": users_with_mfa},
        }
    ...
    try:
        ...
        if human_users_total == 0:
            ...
            if human_users_temp_creds < human_users_total:
                details.append(
                    f"{human_users_total - human_users_temp_creds} human users not using temporary credentials"
                )
    ...
    try:
        ...
        if total_resources == 0:
            ...
            if encrypted_resources < total_resources:
                details.append(
                    f"{total_resources - encrypted_resources} resources not encrypted at rest"
                )
...
async def validate_sec05_bp01(resources: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "score": score,
            "details": details,
            "evidence": {"detectors_enabled": detectors_enabled},
        }
