...
class IAMPasswordPolicyValidator(ValidatorBase):
    ...
    def run(
        ...
        try:
            ...
            good = (
                pwd.get("MinimumPasswordLength", 0) >= 14
                and pwd.get("RequireSymbols", False)
                and pwd.get("RequireNumbers", False)
                and pwd.get("RequireUppercaseCharacters", False)
                and pwd.get("RequireLowercaseCharacters", False)
            )
