...
export default function AnalystView({ evaluation }) {
  ...
  // Las 11 preguntas completas de Security pillar
  const questions = [
    {
      id: 'SEC01',
                          ...
                          <tbody>
                            {selectedQuestion.findings.map((finding, idx) => (
                              <tr key={idx}>
                                ...
                                <td className="evidence-text"><small>{finding.evidence || t('common.notAvailable')}</small></td>
                              </tr>
                            ))}
                          </tbody>
                        </table>
                          ...
                          <div key={idx} className="finding-card">
                            ...
                            {finding.evidence && (
                              <div className="finding-evidence">
                                <small><strong>{t('analyst.evidence')}:</strong> {finding.evidence}</small>
                              </div>
                            )}
                            {finding.risk && (
